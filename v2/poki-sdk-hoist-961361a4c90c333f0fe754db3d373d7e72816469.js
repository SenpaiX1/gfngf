(() => {
  ...
  var g = new Set(["authorize.roblox.com", "accounts.google.com", "appleid.apple.com", "idmsa.apple.com", "login.microsoftonline.com", "login.live.com"]),
    f = new Set(["doubleclick", "googlesyndication", "googleapis", "googleadservices"]),
      ...
      (b = S()) ? (b.previous_page.path = b.page.path, b.previous_page.type = b.page.type, b.previous_page.id = b.page.id, b.previous_page.start = b.page.start, b.previous_page.pageview_id = b.page.pageview_id, b.page.path = e, b.page.type = t, b.page.id = a, b.page.start = Date.now(), b.page.pageview_id = r(), b.depth = _() + 1, b.expire = Date.now() + w) : b = function(e, t, a) {
        ...
        var l = r(),
          b = function() {
            ...
            var V, G = f.has(L) || !!(E || I || _ || P || T || x || O) || "cpc" === b || "rtb-cpm" === b || "ppc" === b || "paid" === b,
              F = (s || "").toLowerCase(),
              U = !g.has(F) && (y.has(L) || /^com\.google\.android\.googlequicksearchbox$/.test(F) || /^webcache\.googleusercontent\.com$/.test(F) || !!k && "share" !== b);
            return V = "snapchat" === v ? "cpc" : T && !v ? "organic" : G ? "cpc" : U ? "organic" : g.has(F) ? "oauth" : "pwa" === L || "poki_android_app" === L || d || "social" === b || "email" === b ? "referral" : L ? "unknown" : "direct", "direct" === L && "direct" !== V && "unknown" !== V && "referral" !== V && (L = "unknown"), f.has(L) && (L = "unknown"), "poki" === L && "cpc" === V && (L = "unknown"), {
              source: L,
              medium: V
            }
          }({
    ...
    static setupObserver() {
      for (Q._pokiSessionGlobalName = "pokiSession", Q._pokiUserGlobalName = "pokiUser", Q._pokiContextGlobalName = "pokiContext", Q._pokiTrackerGlobalName = "pokiTracker", P(window.location.pathname, "external", V.contentGameID), function() {
          var e, t, i, u, p = null === (e = window[window._pokiUserGlobalName]) || void 0 === e ? void 0 : e.id,
            ...
            g = (null === (i = window[window._pokiUserGlobalName]) || void 0 === i ? void 0 : i.version) || 0,
            f = (null === (u = window[window._pokiUserGlobalName]) || void 0 === u ? void 0 : u.ttl) || l;
          p || (p = n(a), m = "1" === n(s), g = parseInt(n(c), 10) || 0, f = parseInt(n(d), 10) || f), p && function(e) {
          ...
          }(p) || (p = r(), m = !0, g = 2, f = l), o(a, p, f), o(s, m ? "1" : "0", f), o(c, g, f), o(d, f, f), window[window._pokiUserGlobalName] = {
            id: p,
            is_new: m,
            version: g,
            ttl: f
  ...
  function fe() {
    if (V.gameID && !V.isPlayground && !V.isPokiExternal && V.isPokiIframe && !ce) {
      ce = !0, window.addEventListener("unhandledrejection", me), window.addEventListener("error", ge);
      try {
        console.error = (...e) => {
          const t = te(e);
  ...
  const wt = async e => {
    ...
    if (o && o.length < 10) {
      ...
      document.body.style.position = "fixed", o = await ft(document.body, {
        filter: e,
        width: window.innerWidth,
        height: window.innerHeight,
        backgroundColor: "#fff"
    ...
    if (t && t.length > 10) {
      e && (t = await (async (e, t) => {
        ...
        const l = new FontFace("TorusBold", "url(https://a.poki-cdn.com/fonts/torus-bold-latin.woff2)").load(),
          [u, p, m, g] = await Promise.all([i, s, d, l]),
          f = document.createElement("canvas");
        f.width = u.width, f.height = u.height;
        const h = f.getContext("2d");
        h.drawImage(u, 0, 0);
        const y = f.width / p.width,
          w = p.height * y,
          v = f.height - w;
        h.drawImage(p, 0, v, f.width, w);
        const b = m.height * y;
        ((e, t, n, o, r, i, a) => {
          e.save(), e.beginPath();
          const s = n + r,
        ...
        const A = 226 * y,
          S = v + 68 * y;
        return h.textAlign = "left", h.textBaseline = "top", h.fillStyle = "#002b50", h.font = `700 ${56*y}px TorusBold,sans-serif`, h.fillText(n, A, S), f.toDataURL()
      })(t, e));
      return await wt({
        screenshot: t
      })
  ...
  function Sn(e, t) {
    ...
    return r = setInterval((() => {
      if (Ut || !Ht || !Kt.length || i > 10) return console.info("%cPOKI_PLAYTEST:%c", "font-weight: bold", "", Ut ? "stopped" : "crashed", Ut, !Ht, !Kt.length, i), window.removeEventListener("pointermove", mn), window.removeEventListener("pointerdown", gn), window.removeEventListener("pointerup", fn), window.removeEventListener("contextmenu", fn), clearInterval(o), Ct(""), Ht = null, qt = null, Yt = null, Wt = null, kn([]), jt.destroy(), Vt.destroy(), clearInterval(r), a && clearTimeout(a), void t();
      if (!wn(Kt)) {
  ...
  const Mn = class {
      ...
      init = (t = {}) => {
        ...
        return this.#S = new Promise((n => {
          this.__monetization.init({
            ...
            version: "961361a4c90c333f0fe754db3d373d7e72816469"
          })
        })), this.#S
      };
      #I = () => {
      ...
      setDebug = (t = !0) => {
        ...
        n.endsWith("poki-gdn.com") ? t && Z.track(e.tracking.debugTrueInProduction) : (F.debug = t, F.log = t ?? F.log, t ? function() {
          if (ce) {
            ce = !1, window.removeEventListener("unhandledrejection", me), window.removeEventListener("error", ge);
            try {
              console.error = ae
            } catch {}
          }
      ...
      gameplayStart = t => {
        ...
        }), 0), clearTimeout(this.#g), this.#g = setTimeout((() => {
      ...
      gameplayStop = t => {
        this.__logCall("gameplayStop", t), this.#P() ? q("PokiSDK.gameplayStart() ignored because of too many events") : (this.#m = !1, Z.track(e.tracking.screen.gameplayStop, {
          ...t,
          fps: this.#f.stats()
        }), clearTimeout(this.#g), window.removeEventListener("pointermove", this.#T), document.removeEventListener("keydown", this.#T), this.#y = performance.now())
      };
      customEvent = (t, n, o = {}) => {
      ...
      #T = () => {
        window.removeEventListener("pointermove", this.#T), document.removeEventListener("keydown", this.#T), Z.track(e.tracking.screen.playerActive), this.#g = setTimeout((() => {
          window.addEventListener("pointermove", this.#T), document.addEventListener("keydown", this.#T)
        }), 6e5)
      };
      #E = e => {
  ...
  function Yn(e) {
    ...
    window.addEventListener("beforeunload", (() => {
      ...
      s = [], o || (n = d), qn({
        ...
        total_duration: d,
        timed_out: !0,
        sdk_version: "961361a4c90c333f0fe754db3d373d7e72816469",
        fpss: c,
        upvotes: r,
        downvotes: i,
  ...
  function io(t, n, o) {
    ...
    r && (Zn = new WebSocket("wss://playtest-recorder.poki.io/ws"), Zn.addEventListener("error", (() => {
      ...
      Zn.addEventListener("close", (t => {
        console.info("%cPOKI_PLAYTEST:%c websocket closed", "font-weight: bold", "", t), Jn = () => {}, z.removeEventListener(e.playtest.startVideo, u), z.removeEventListener(e.playtest.stopVideo, p), clearInterval(l), clearInterval(g), i.stop(), Ut = !0, Zn = null, ro(), Z.track(e.tracking.playtest.closed, {
  ...
  function po(e, t, n) {
    return t && function(e, t) {
      for (var n = 0; n < t.length; n++) {
        var o = t[n];
        o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, yo(o.key), o)
      }
  ...
  function vo(e, t) {
    if (e) {
      ...
      return "Object" === n && e.constructor && (n = e.constructor.name), "Map" === n || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? lo(e, t) : void 0
    }
  }
  var bo = po((function e(t) {
    uo(this, e), this.p = new Promise(t)
  }));
  bo.__typeson__type__ = "TypesonPromise", "undefined" != typeof Symbol && Object.defineProperty(bo.prototype, Symbol.toStringTag, {
    get: function() {
      return "TypesonPromise"
    }
  }), bo.prototype.then = function(e, t) {
    var n = this;
    return new bo((function(o, r) {
      n.p.then((function(t) {
        o(e ? e(t) : t)
      })).catch((function(e) {
  ...
  var ko = Object.hasOwn,
    Ao = Object.getPrototypeOf;

  function So(e, t) {
    return To(e) && "function" == typeof e.then && (!t || "function" == typeof e.catch)
  }
  ...
  function Io(e, t) {
    if (!e || "object" !== wo(e)) return !1;
    var n = Ao(e);
    if (!n) return null === t;
    var o = ko(n, "constructor") && n.constructor;
  ...
  function _o(e) {
    return !(!e || "Object" !== Eo(e)) && (!Ao(e) || Io(e, Object))
  }

  function Po(e) {
    if (!e || "Object" !== Eo(e)) return !1;
    var t = Ao(e);
    return !t || Io(e, Object) || Po(t)
  }
  ...
  function Co(e, t) {
    if ("" === t) return e;
    if (null === e || "object" !== wo(e)) throw new TypeError("Unexpected non-object type");
    var n = t.indexOf(".");
    if (-1 !== n) {
      var o = e[Oo(t.slice(0, n))];
      return void 0 === o ? void 0 : Co(o, t.slice(n + 1))
    }
    return e[Oo(t)]
  }
  ...
  function Do(e, t, n) {
    if ("" === t) return n;
    if (!e || "object" !== wo(e)) throw new TypeError("Unexpected non-object type");
    if ("__proto__" === t) throw new TypeError("Invalid property");
    var o = t.indexOf(".");
    return -1 !== o ? Do(e[Oo(t.slice(0, o))], t.slice(o + 1), n) : (e[Oo(t)] = n, e)
  }

  function Lo(e) {
    return null === e ? "null" : Array.isArray(e) ? "array" : wo(e)
  }
  ...
  var No = Object.keys,
    Bo = Object.hasOwn,
    Ro = Array.isArray,
    jo = ["type", "replaced", "iterateIn", "iterateUnsetNumeric", "addLength"];
  ...
  var Fo = po((function e(t) {
      uo(this, e), this.options = t, this.plainObjectReplacers = [], this.nonplainObjectReplacers = [], this.revivers = {}, this.types = {}
    }), [{
      key: "stringify",
      value: function(e, t, n, o) {
        o = fo(fo(fo({}, this.options), o), {}, {
          stringification: !0
        });
        var r = this.encapsulate(e, null, o);
        return Ro(r) ? JSON.stringify(r[0], t, n) : r.then((function(e) {
      ...
      key: "stringifySync",
      value: function(e, t, n, o) {
        return this.stringify(e, t, n, fo(fo({
      ...
      value: function(e, t, n) {
        return n = fo(fo(fo({}, this.options), n), {}, {
          parse: !0
      ...
      value: function(e, t, n) {
        var o = this,
          ...
          p = function(e) {
            ...
            if (r.iterateNone) return t.length ? t[0] : Lo(e);
            if (t.length) {
              ...
              e && _o(e) && !Bo(e, "$types") ? e.$types = a : e = {
                $: e,
                $types: {
                  $: a
                }
              }
            } else To(e) && Bo(e, "$types") && (e = {
              $: e,
              $types: !0
            });
          ...
          m = Vo((function(e, t) {
            return Mo(Promise.all(t.map((function(e) {
              return e[1].p
            }))), (function(n) {
              return Mo(Promise.all(n.map(Vo((function(n) {
                var o = !1,
                  r = [],
                  i = ho(t.splice(0, 1), 1),
                  a = ho(i[0], 7),
                ...
                return function(e, t) {
                  ...
                  if (s && h) return Mo(g.p, (function(t) {
                    l[u] = t;
                    var n = m(e, r);
                    return o = !0, n
                  }))
                }), (function(t) {
                  return o ? t : (s ? l[u] = g : e = h ? g.p : g, m(e, r))
                }))
              })))), (function() {
                return e
              }))
          ...
          g = function(e, t, n) {
            Object.assign(e, t);
            var o = jo.map((function(t) {
              var n = e[t];
              return delete e[t], n
            }));
            n(), jo.forEach((function(t, n) {
              e[t] = o[n]
            }))
          },
          f = function(e, t, n, i, d, l, p) {
            var m, y = {},
              w = wo(t),
              v = u ? function(o) {
                var r, a = null !== (r = null != p ? p : i.type) && void 0 !== r ? r : Lo(t);
                u(Object.assign(null != o ? o : y, {
                  ...
                  awaitingTypesonPromise: Io(t, bo)
                }, {
                  type: a
                }))
              } : null;
            ...
            if (n && !i.iterateIn && !i.iterateUnsetNumeric && t && "object" === wo(t)) {
              var b = s.indexOf(t);
            ...
            if (E !== t ? (m = E, y = {
                replaced: E
              }) : "" === e && Io(t, bo) ? (d.push([e, t, n, i, void 0, void 0, i.type]), m = t) : S && "object" !== i.iterateIn || "array" === i.iterateIn ? (k = new Array(t.length), y = {
                clone: k
              }) : (["function", "symbol"].includes(wo(t)) || "toJSON" in t || Io(t, bo) || Io(t, Promise) || Io(t, ArrayBuffer)) && !A && "object" !== i.iterateIn ? m = t : (k = {}, i.addLength && (k.length = t.length), y = {
                clone: k
            ...
            if (i.iterateIn) {
              var I = function(o) {
                ...
                g(i, r, (function() {
                  var r = e + (e ? "." : "") + xo(o),
                    a = f(r, t[o], Boolean(n), i, d, l);
                  Io(a, bo) ? d.push([r, a, Boolean(n), i, k, o, i.type]) : void 0 !== a && (k[o] = a)
                }))
              };
              for (var _ in t) I(_);
              v && v({
            ...
            } else No(t).forEach((function(o) {
              var r = e + (e ? "." : "") + xo(o);
              g(i, {
                ownKeys: !0
              }, (function() {
                var e = f(r, t[o], Boolean(n), i, d, l);
                Io(e, bo) ? d.push([r, e, Boolean(n), i, k, o, i.type]) : void 0 !== e && (k[o] = e)
              }))
            })), v && v({
              endIterateOwn: !0,
              end: !0
              ...
              for (var P = t.length, T = function(o) {
                  if (!(o in t)) {
                    ...
                    g(i, {
                      ...
                      var e = f(r, void 0, Boolean(n), i, d, l);
                      Io(e, bo) ? d.push([r, e, Boolean(n), i, k, o, i.type]) : void 0 !== e && (k[o] = e)
                    }))
                  }
                }, x = 0; x < P; x++) T(x);
          ...
          h = function(e, t, n, r, s, c, d) {
            for (var u = s ? o.plainObjectReplacers : o.nonplainObjectReplacers, p = u.length; p--;) {
              ...
              if (m.test(t, n)) {
                ...
                return f(e, y, l && "readonly", n, r, c, g)
              }
            }
            return t
          },
      ...
      key: "encapsulateSync",
      value: function(e, t, n) {
        return this.encapsulate(e, t, fo(fo({
          throwOnBadSyncType: !0
        }, n), {}, {
          sync: !0
        }))
      ...
      value: function(e, t) {
        ...
        if (!e || "object" !== wo(e) || Array.isArray(e)) return i(e);
        var a = e.$types;
        if (!0 === a) return i(e.$);
        if (!a || "object" !== wo(a) || Array.isArray(a)) return i(e);
        var s = [],
          c = {},
          d = !0;
        a.$ && _o(a.$) && (e = e.$, a = a.$, d = !1);
        var l = function(e, t) {
            var o, i = ho(null !== (o = n.revivers[e]) && void 0 !== o ? o : [], 1)[0];
        ...
        var m, g = function() {
          ...
          if (Object.entries(a).forEach((function(e) {
              ...
              "#" !== i && [].concat(i).forEach((function(e) {
                var o;
                ho(null !== (o = n.revivers[e]) && void 0 !== o ? o : [null, {}], 2)[1].plain && (t.push({
                  keypath: r,
                  type: e
                }), delete a[r])
              }))
            })), t.length) return t.sort(Go), t.reduce((function t(n, o) {
            var r = o.keypath,
              i = o.type;
            if (So(n)) return n.then((function(e) {
              return t(e, {
                keypath: r,
                type: i
              })
            ...
            var a = Co(e, r);
            if (Io(a = l(i, a), bo)) return a.then((function(t) {
              var n = Do(e, r, t);
              n === t && (e = n)
            }));
            var s = Do(e, r, a);
        ...
        return Io(g, bo) ? m = g.then((function() {
          return e
          ...
          if (!d || "$types" !== t) {
            ...
            if (p || _o(n)) {
              ...
              for (No(n).forEach((function(r) {
                  var i = e(t + (t ? "." : "") + xo(r), n[r], null != o ? o : m, m, r),
                    a = function(e) {
                      return Io(e, Uo) ? m[r] = void 0 : void 0 !== e && (m[r] = e), e
                    };
                  Io(i, bo) ? u.push(i.then((function(e) {
                    return a(e)
                  }))) : a(i)
                })), n = m; s.length;) {
                var g = ho(s[0], 4),
        ...
        }("", e, null), u.length && (m = bo.resolve(m).then((function(e) {
          return bo.all([e].concat(u))
        })).then((function(e) {
          return ho(e, 1)[0]
        })))), So(m) ? r && o.throwOnBadSyncType ? function() {
          throw new TypeError("Sync method requested but async result obtained")
        }() : Io(m, bo) ? m.p.then(p) : m : !r && o.throwOnBadSyncType ? function() {
  ...
  Uo.__typeson__type__ = "TypesonUndefined";
  for (var Ko = ["null", "boolean", "number", "string", "array", "object"], zo = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", Ho = new Uint8Array(256), qo = 0; qo < 64; qo++) Ho[zo.codePointAt(qo)] = qo;
  var Yo = function(e, t, n) {
      null == n && (n = e.byteLength);
      for (var o = new Uint8Array(e, 0, n), r = o.length, i = "", a = 0; a < r; a += 3) i += zo[o[a] >> 2], i += zo[(3 & o[a]) << 4 | o[a + 1] >> 4], i += zo[(15 & o[a + 1]) << 2 | o[a + 2] >> 6], i += zo[63 & o[a + 2]];
    ...
    Wo = function(e, t) {
      ...
      for (var d = new ArrayBuffer(s, t), l = new Uint8Array(d), u = 0; u < n; u += 4) o = Ho[e.codePointAt(u)], r = Ho[e.codePointAt(u + 1)], i = Ho[e.codePointAt(u + 2)], a = Ho[e.codePointAt(u + 3)], l[c++] = o << 2 | r >> 4, l[c++] = (15 & r) << 4 | i >> 2, l[c++] = (3 & i) << 6 | 63 & a;
      return d
    };
  const $o = {
      arraybuffer: {
        test: e => "ArrayBuffer" === Eo(e),
        replace(e, t) {
          t.buffers || (t.buffers = []);
    ...
    Jo = {
      bigintObject: {
        test: e => "object" == typeof e && Io(e, BigInt),
        replace: String,
  ...
  const er = {
    blob: {
      ...
      revive(e) {
        ...
        return new Blob([Xo(n)], {
          type: t
        })
      },
      replaceAsync: e => new bo(((t, n) => {
        const o = new FileReader;
        o.addEventListener("load", (() => {
          t({
            type: e.type,
            stringContents: Zo(o.result)
          })
  ...
  const tr = {
      cryptokey: {
        test: e => "CryptoKey" === Eo(e) && e.extractable,
        replaceAsync: e => new bo((async (t, n) => {
          let o;
          try {
    ...
    nr = {
      dataview: {
        ...
        revive(e, t) {
          ...
          let c;
          return "index" in e ? c = t.buffers[i] : (c = Wo(r, s ? {
            maxByteLength: a
  ...
  "undefined" != typeof DOMMatrix && ar(DOMMatrix), "undefined" != typeof DOMMatrixReadOnly && ar(DOMMatrixReadOnly);
  const sr = {};

  function cr(e) {
    sr[e.name.toLowerCase()] = {
      test: t => Eo(t) === e.name,
      replace: e => ({
        x: e.x,
        y: e.y,
  ...
  "undefined" != typeof DOMPoint && cr(DOMPoint), "undefined" != typeof DOMPointReadOnly && cr(DOMPointReadOnly);
  const dr = {
      domquad: {
        test: e => "DOMQuad" === Eo(e),
        replace: e => ({
  ...
  "undefined" != typeof DOMRect && ur(DOMRect), "undefined" != typeof DOMRectReadOnly && ur(DOMRectReadOnly);
  const pr = {
      error: {
        test: e => "Error" === Eo(e),
        replace: ({
  ...
  } [TypeError, RangeError, SyntaxError, ReferenceError, EvalError, URIError].forEach((e => gr(e))), "undefined" != typeof AggregateError && gr(AggregateError), "function" == typeof InternalError && gr(InternalError);
  const fr = {
      file: {
        test: e => "File" === Eo(e),
        replace(e) {
        ...
        replaceAsync: e => new bo((function(t, n) {
          const o = new FileReader;
    ...
    yr = {
      imagebitmap: {
        test: e => "ImageBitmap" === Eo(e) || e && e.dataset && "ImageBitmap" === e.dataset.toStringTag,
        replace(e) {
          const t = document.createElement("canvas");
        ...
        reviveAsync(e) {
          ...
          return o.addEventListener("load", (function() {
            n.drawImage(o, 0, 0)
          })), o.src = e.dataURL, new bo((async (e, n) => {
            try {
    ...
    kr = {
      IntlCollator: br,
      IntlDateTimeFormat: {
        test: e => Io(e, Intl.DateTimeFormat),
        replace: e => e.resolvedOptions(),
        revive: e => new Intl.DateTimeFormat(e.locale, e)
      },
      IntlNumberFormat: {
        test: e => Io(e, Intl.NumberFormat),
        replace: e => e.resolvedOptions(),
    ...
    _r = {
      StringObject: {
        test: e => "String" === Eo(e) && "object" == typeof e,
        replace: String,
        revive: e => new String(e)
      },
      BooleanObject: {
        test: e => "Boolean" === Eo(e) && "object" == typeof e,
        replace: e => e.valueOf(),
        revive: e => new Boolean(e)
      },
      NumberObject: {
        test: e => "Number" === Eo(e) && "object" == typeof e,
        replace: Number,
  ...
  "function" == typeof Int8Array && [Int8Array, Uint8Array, Uint8ClampedArray, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, ..."function" == typeof BigInt64Array ? [BigInt64Array, BigUint64Array] : []].forEach((e => function(e) {
    ...
    xr[t.toLowerCase()] = {
      ...
      revive: t => "ArrayBuffer" === Eo(t) ? new e(t) : t
    }
  }(e)));
  const Or = {};
  "function" == typeof Int8Array && [Int8Array, Uint8Array, Uint8ClampedArray, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, ..."function" == typeof BigInt64Array ? [BigInt64Array, BigUint64Array] : []].forEach((e => function(e) {
    ...
    Or[t.toLowerCase()] = {
      ...
      revive(t, n) {
        ...
        let d;
        return "index" in t ? d = n.buffers[a] : (d = Wo(i, c ? {
          maxByteLength: s
  ...
  const Cr = {
    ...
    Mr = [Sr, vr, Er, Ir],
    Nr = ([Cr, Lr, _r, Mr, or, pr, mr, Pr].concat("function" == typeof Map ? Ar : [], "function" == typeof Set ? Tr : [], "function" == typeof ArrayBuffer ? $o : [], "function" == typeof Uint8Array ? Or : [], "function" == typeof DataView ? nr : [], "undefined" != typeof Intl ? kr : [], "undefined" != typeof BigInt ? [Qo, Jo] : []), [Dr, Cr, Lr, _r, Mr, or, Pr, wr, yr, fr, hr, er, pr, mr].concat("function" == typeof Map ? Ar : [], "function" == typeof Set ? Tr : [], "function" == typeof ArrayBuffer ? $o : [], "function" == typeof Uint8Array ? Or : [], "function" == typeof DataView ? nr : [], "undefined" != typeof crypto ? tr : [], "undefined" != typeof BigInt ? [Qo, Jo] : [], "undefined" != typeof DOMException ? rr : [], "undefined" != typeof DOMRect ? lr : [], "undefined" != typeof DOMPoint ? sr : [], "undefined" != typeof DOMQuad ? dr : [], "undefined" != typeof DOMMatrix ? ir : []));
  Nr.concat({
  ...
  function Rr(e, t, n, o, r, i) {
    return Ur(function(e, t) {
      return e << t | e >>> 32 - t
    }(Ur(Ur(t, e), Ur(o, i)), r), n)
  }

  function jr(e, t, n, o, r, i, a) {
    return Rr(t & n | ~t & o, e, t, r, i, a)
  }

  function Vr(e, t, n, o, r, i, a) {
    return Rr(t & o | n & ~o, e, t, r, i, a)
  }

  function Gr(e, t, n, o, r, i, a) {
    return Rr(t ^ n ^ o, e, t, r, i, a)
  }

  function Fr(e, t, n, o, r, i, a) {
    return Rr(n ^ (t | ~o), e, t, r, i, a)
  }
  ...
  try {
      ...
      const t = function(e) {
        ...
        for (var n = 1732584193, o = -271733879, r = -1732584194, i = 271733878, a = 0; a < e.length; a += 16) {
          const t = n,
            ...
            c = r,
            d = i;
          o = Fr(o = Fr(o = Fr(o = Fr(o = Gr(o = Gr(o = Gr(o = Gr(o = Vr(o = Vr(o = Vr(o = Vr(o = jr(o = jr(o = jr(o = jr(o, r = jr(r, i = jr(i, n = jr(n, o, r, i, e[a + 0], 7, -680876936), o, r, e[a + 1], 12, -389564586), n, o, e[a + 2], 17, 606105819), i, n, e[a + 3], 22, -1044525330), r = jr(r, i = jr(i, n = jr(n, o, r, i, e[a + 4], 7, -176418897), o, r, e[a + 5], 12, 1200080426), n, o, e[a + 6], 17, -1473231341), i, n, e[a + 7], 22, -45705983), r = jr(r, i = jr(i, n = jr(n, o, r, i, e[a + 8], 7, 1770035416), o, r, e[a + 9], 12, -1958414417), n, o, e[a + 10], 17, -42063), i, n, e[a + 11], 22, -1990404162), r = jr(r, i = jr(i, n = jr(n, o, r, i, e[a + 12], 7, 1804603682), o, r, e[a + 13], 12, -40341101), n, o, e[a + 14], 17, -1502002290), i, n, e[a + 15], 22, 1236535329), r = Vr(r, i = Vr(i, n = Vr(n, o, r, i, e[a + 1], 5, -165796510), o, r, e[a + 6], 9, -1069501632), n, o, e[a + 11], 14, 643717713), i, n, e[a + 0], 20, -373897302), r = Vr(r, i = Vr(i, n = Vr(n, o, r, i, e[a + 5], 5, -701558691), o, r, e[a + 10], 9, 38016083), n, o, e[a + 15], 14, -660478335), i, n, e[a + 4], 20, -405537848), r = Vr(r, i = Vr(i, n = Vr(n, o, r, i, e[a + 9], 5, 568446438), o, r, e[a + 14], 9, -1019803690), n, o, e[a + 3], 14, -187363961), i, n, e[a + 8], 20, 1163531501), r = Vr(r, i = Vr(i, n = Vr(n, o, r, i, e[a + 13], 5, -1444681467), o, r, e[a + 2], 9, -51403784), n, o, e[a + 7], 14, 1735328473), i, n, e[a + 12], 20, -1926607734), r = Gr(r, i = Gr(i, n = Gr(n, o, r, i, e[a + 5], 4, -378558), o, r, e[a + 8], 11, -2022574463), n, o, e[a + 11], 16, 1839030562), i, n, e[a + 14], 23, -35309556), r = Gr(r, i = Gr(i, n = Gr(n, o, r, i, e[a + 1], 4, -1530992060), o, r, e[a + 4], 11, 1272893353), n, o, e[a + 7], 16, -155497632), i, n, e[a + 10], 23, -1094730640), r = Gr(r, i = Gr(i, n = Gr(n, o, r, i, e[a + 13], 4, 681279174), o, r, e[a + 0], 11, -358537222), n, o, e[a + 3], 16, -722521979), i, n, e[a + 6], 23, 76029189), r = Gr(r, i = Gr(i, n = Gr(n, o, r, i, e[a + 9], 4, -640364487), o, r, e[a + 12], 11, -421815835), n, o, e[a + 15], 16, 530742520), i, n, e[a + 2], 23, -995338651), r = Fr(r, i = Fr(i, n = Fr(n, o, r, i, e[a + 0], 6, -198630844), o, r, e[a + 7], 10, 1126891415), n, o, e[a + 14], 15, -1416354905), i, n, e[a + 5], 21, -57434055), r = Fr(r, i = Fr(i, n = Fr(n, o, r, i, e[a + 12], 6, 1700485571), o, r, e[a + 3], 10, -1894986606), n, o, e[a + 10], 15, -1051523), i, n, e[a + 1], 21, -2054922799), r = Fr(r, i = Fr(i, n = Fr(n, o, r, i, e[a + 8], 6, 1873313359), o, r, e[a + 15], 10, -30611744), n, o, e[a + 6], 15, -1560198380), i, n, e[a + 13], 21, 1309151649), r = Fr(r, i = Fr(i, n = Fr(n, o, r, i, e[a + 4], 6, -145523070), o, r, e[a + 11], 10, -1120210379), n, o, e[a + 2], 15, 718787259), i, n, e[a + 9], 21, -343485551), n = Ur(n, t), o = Ur(o, s), r = Ur(r, c), i = Ur(i, d)
        }
    ...
    }(e), Kr = localStorage.getItem("savegame_idbfs_hash")
  } catch {}
  ...
  const qr = 5e3,
    Yr = 15e3,
    Wr = "poki_gs_state_token",
    $r = "poki_playtime",
    Jr = [Wr, $r],
    Qr = [];
  let Zr = performance.now();
  async function Xr() {
    ...
    const e = await indexedDB.databases();
    0 === e.length && (console.info("%cPOKI_SAVEGAME:%c No databases found, using IDBDatabaseInfos", "font-weight: bold", "", Qr.map((e => e.name))), e.push(...Qr));
    const t = [];
    e.forEach((async e => {
      var n;
  ...
  function ei() {
    ...
    const e = (new Fo).register([Nr]),
      t = () => {
        const t = performance.now(),
          n = Math.ceil((t - Zr) / 1e3);
        let o = 0;
        try {
          o = Number.parseInt(localStorage.getItem($r) || "0", 10)
        } catch (e) {
    ...
    function n(e, t) {
      ...
      Qr.find((n => n.name === e && n.version === t)) || Qr.push(n)
    }
    so(`(${function(){window.addEventListener("storage",(e=>{e.key&&["poki_gs_state_token","poki_playtime"].includes(e.key)||window?.parent?.postMessage({type:"LocalStorageChanged"},"*")}))}.toString()})();`);
    const o = Br((() => {
  ...
  class oi {
    ...
    init = e => {
      ...
      co(), V.cloudSaveGames && ei(), V.kioskMode && document.addEventListener("keydown", (e => {
    ...
    requestAd(t) {
      ...
      if (this.#D === ti) this.#D = ni, this.#x[a] = {
        position: r,
        onStart: () => {
        ...
        case "hoist_videoAd_onFinish": {
          ...
          if (n) {
            ...
            if (this.#D === ni) {
              ...
              return this.#D = ti, void delete this.#x[t]
            }
            if (r) try {
              r(o)
            } catch (e) {
            ...
            z.dispatchEvent(e.playtest.stopVideo), this.#D = ti, delete this.#x[t]
          }
          break
        }
  ...
  const ri = new class extends Mn {
    constructor() {
      super(new oi, !0), window.addEventListener("message", this.__monetization.handleMessageReceived)
    }
  };
  for (const e in ri) e.startsWith("__") || (window.PokiSDK[e] = ri[e])
})();