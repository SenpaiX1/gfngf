(() => {
  ...
  const a = (() => {
      const n = window.pokiSDKVersion || e("ab") || "7ddbfbd35934ef0ed8ae8c0197b21fd611309298";
      let a = `poki-sdk-core-${n}.js`;
      return t && (a = `poki-sdk-kids-${n}.js`), o && (a = `poki-sdk-playground-${n}.js`), i && (a = `poki-sdk-hoist-${n}.js`), `v2/poki-sdk-hoist-961361a4c90c333f0fe754db3d373d7e72816469.js`
    })(),
